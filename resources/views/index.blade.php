...
<body class="relative">
    ...
    <aside class="hidden md:block bg-white font-semibold w-[280px] h-screen absolute left-0 top-0 shadow p-5">
        ...
        <div class="bg-indigo-600 text-white rounded-full px-5 py-3 mt-5">
            <a href="">
                <p><i class="bi bi-cash"></i> Keuangan</p>
            </a>
        </div>
    ...
    <aside class="block md:hidden fixed bottom-0 left-0 right-0 h-16 z-20 flex shadow bg-white justify-around items-center">
        <div>
